...
fn main() {
    ...
    let root_project_dir = cargo_manifest_dir
        .parent()
        .unwrap()
        .parent()
        .unwrap()
    ...
    cxx_build::bridge("src/bridge.rs")
        ...
        .include(root_project_dir.join("detection").display().to_string())
    ...
    let base_search_dir = root_project_dir.join("lib").join("linux");
